...
String formno;
    ...
    SignupThree(String formno){
        ...
        setLayout(null);
        JLabel l1 = new JLabel("Page 3: Accounts Deatils");
        l1.setFont(new Font("Raleway", Font.BOLD,22));
        l1.setBounds(280, 40, 400, 40);
        add(l1);
        
        
          JLabel type = new JLabel("Accounts Type");
        ...
        JLabel cdetails = new JLabel("You 16 digit card number:");
        ...
        JLabel services = new JLabel("Services Requiered:");
        ...
        if(c1.isSelected()){ 
         ...
         try{
                ...
                if(accountType.equals("")){
                    JOptionPane.showMessageDialog(null, "Account type is requiered");
                }else{
                    Conn c = new Conn();
